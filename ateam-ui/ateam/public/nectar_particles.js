...
(function ($) {
    ...
    var $selector =
        $(".nectar-box-roll").length > 0
            ? ".nectar-box-roll .shape"
            : ".nectar-particles .shape";
    ...
    function initSetup() {
        ...
        $($selector).each(function (i) {
            $shapes[i] = {
                ...
                colorMapping:
                    $(this).attr("data-color-mapping").length > 0
                        ? $(this).attr("data-color-mapping")
                        : "original",
                color:
                    $(this).attr("data-color").length > 0
                        ? $(this).attr("data-color")
                        : "#fefefe",
                backgroundColor:
                    $(this).attr("data-bg-color").length > 0
                        ? $(this).attr("data-bg-color")
                        : "transparent",
                colorAlpha:
                    $(this).attr("data-alpha").length > 0
                        ? $(this).attr("data-alpha")
                        : "original",
                density:
                    $(this).attr("data-density").length > 0
                        ? parseInt($(this).attr("data-density"))
                        : 13,
                densityOriginal:
                    $(this).attr("data-density").length > 0
                        ? parseInt($(this).attr("data-density"))
                        : 13,
                maxParticleSize:
                    $(this).attr("data-max-size").length > 0
                        ? parseInt($(this).attr("data-max-size"))
                        : 3,
                maxParticleSizeOriginal:
                    $(this).attr("data-max-size").length > 0
                        ? parseInt($(this).attr("data-max-size"))
                        : 3,
            };
    ...
    var Nodes = {
        ...
        randomMovement:
            ...
            $("body").hasClass("seasons") ||
            $("body").hasClass("join") ||
            $("body").hasClass("passwords"),
        ...
        disableExplosion: $("#page-header-bg .nectar-particles").attr(
            "data-disable-explosion"
        ),
        rotateTimer: parseInt(
            $("#page-header-bg .nectar-particles").attr("data-rotation-timing")
        ),
        ...
        init: function (canvasID) {
            ...
            if ($(canvasID).parents(".nectar-box-roll").length > 0) {
                ...
                console.log("nectar particles mouse move");
                $(canvasID)
                    .parents(".nectar-particles")
            ...
            if (
                $("#page-header-bg:not(.fullscreen-header)").length > 0 &&
                $(window).width() < 1000
            ) {
        ...
        preparePoints: function (index, index2, resize) {
            ...
            if (!jQuery.isArray(this.bgImage[index])) {
                ...
                if (typeof this.points[index] !== "object")
                    this.points[index] = {};
            ...
            for (
                ...
                i += this.imgsToDraw[index].density
            ) {
                for (
                    j = 0;
                    j < this.canvas.width;
                    j += this.imgsToDraw[index].density
                ) {
                    var pixelPosition =
                        (j + i * this.bgContextPixelData.width) * 4;
                    ...
                    //all others
                        ...
                        var prevIndex =
                            index == this.points.length ? 0 : index - 1;
                        if (
                            !jQuery.isArray(this.points[prevIndex]) &&
                            typeof this.points[prevIndex] === "object"
                        ) {
                            var prevIndex2 =
                                index2 == this.points[prevIndex].length
                                    ? 0
                                    : index2 - 1;
                            mathRnd = Math.random();
                            xPos =
                                this.points[prevIndex][prevIndex2][
                                    Math.floor(
                                        mathRnd *
                                            this.points[prevIndex][prevIndex2]
                                                .length
                            ...
                            xPos =
                                this.points[prevIndex][
                                    Math.floor(
                                        mathRnd * this.points[prevIndex].length
                                    )
                                ].originalX;
                            yPos =
                                this.points[prevIndex][
                    ...
                    if (!jQuery.isArray(this.bgImage[index])) {
                        this.points[index].push({
                            ...
                            baseRadius: Math.ceil(
                                rndNum * this.imgsToDraw[index].maxParticleSize
                            ),
            ...
            for (var u = 0; u < this.points[index].length; u++) {
                ...
                if (window.innerWidth < 690) {
                    ...
                    if (
                        this.points[index].length > 150 &&
                        randomNum >
                            Math.floor(this.points[index].length / divider)
                    ) {
                    ...
                    if (this.points[index].length > 800) {
                        ...
                        this.points[index].length <= 800 &&
                        this.points[index].length > 600
                    ) {
                        divider = 4.5;
                    } else if (
                        this.points[index].length <= 600 &&
                        this.points[index].length > 400
                    ) {
                        divider = 3.5;
                ...
                if (Nodes.loaded == false) {
                        ...
                        if (Nodes.sequenceActive == false) {
                            currentPoint.baseRadius = Math.ceil(
                                currentPoint.randomNum *
                                    Nodes.imgsToDraw[
                                        Math.floor(this.currentShapeIndex)
                                    ].maxParticleSize
                            );
                            ...
                            if (
                                typeof this.points[
                                    Math.floor(this.currentShapeIndex)
                                ][Nodes.currentSequenceIndex][i] !== "undefined"
                            ) {
                                currentPoint.x +=
                                    Math.cos(theta) * distance +
                                    (this.points[
                    ...
                    //random movement
                        ...
                        if (currentPoint.x < -(this.canvas.width * 0.1)) {
                            ...
                            currentPoint.toX =
                                this.canvas.width * 1.1 - this.ran(20, 40) * 4;
                        }
                        ...
                        if (currentPoint.y < -(this.canvas.height * 0.1)) {
                            ...
                            currentPoint.toY =
                                this.canvas.height * 1.1 - this.ran(20, 40) * 4;
                        }
                        ...
                        currentPoint.toX +=
                            Math.floor(
                                (this.impulsX * sizeMovement * 30) / 30
                            ) +
                            (this.impulsX / 7) * currentPoint.randomPosX;
                        currentPoint.toY +=
                            Math.floor(
                                (this.impulsY * sizeMovement * 30) / 30
                            ) +
        ...
        loadData: function (data, index, index2, sequence) {
            if (sequence == true) {
                if (typeof this.bgImage[index] !== "object")
                    this.bgImage[index] = [];
            ...
            if (Math.random() > explodeChance || seek !== false) {
                ...
                if (seek !== false) {
                    ...
                    Nodes.currentShapeIndex =
                        Nodes.currentShapeIndex + 1 == Nodes.imgsToDraw.length
                            ? 0
                            : Nodes.currentShapeIndex + 1;
                }
                ...
                var prevIndex =
                    Nodes.currentShapeIndex == Nodes.points.length
                        ? 0
                        : Math.floor(Nodes.currentShapeIndex - 1);
                ...
                for (
                    var i = 0;
                    i < Nodes.points[Nodes.currentShapeIndex].length;
                    i++
                ) {
                    mathRnd = Math.random();
                    ...
                    if (seek !== false) {
                        xPos =
                            Nodes.points[Nodes.prevShapeIndex][
                                Math.floor(
                                    mathRnd *
                                        Nodes.points[Nodes.prevShapeIndex]
                                            .length
                        ...
                        if (Nodes.randomMovement == true) {
                            ...
                            xPos =
                                Nodes.points[prevIndex][
                                    Math.floor(
                                        mathRnd * Nodes.points[prevIndex].length
                                    )
                                ].x;
                            yPos =
                                Nodes.points[prevIndex][
                ...
                var $paginationTimeout =
                    Nodes.randomMovement == true ? 300 : 300;
                if (
                    !(
                        $("body").hasClass("sessions") ||
                        $("body").hasClass("seasons") ||
                ...
                for (i = 0; i < Nodes.points[prevIndex].length; i++) {
                    mathRnd = Math.random();
                    xPos =
                        Nodes.points[prevPrevIndex][
                            Math.floor(
                                mathRnd * Nodes.points[prevPrevIndex].length
                            )
                        ].originalX;
                    yPos =
                        Nodes.points[prevPrevIndex][
                    ...
                    Nodes.points[prevIndex][i].toX =
                        Math.random() * window.innerWidth;
                    Nodes.points[prevIndex][i].toY =
                        Math.random() * window.innerHeight;
                ...
                if (seek !== false) {
                    ...
                    currentCaptionIndex =
                        Nodes.currentShapeIndex == 0
                            ? Nodes.imgsToDraw.length
                            : Nodes.currentShapeIndex;
                    nextCaptionIndex =
                        Nodes.currentShapeIndex == Nodes.points.length
                            ? 0
                ...
                if (
                    $(Nodes.canvasID)
                        .parents($selector)
                        .find(".pagination-navigation").length > 0 &&
                    seek == false
                ) {
                    setTimeout(function () {
                        $(Nodes.canvasID)
        ...
        canvasBgColor: function () {
            jQuery(Nodes.canvasID)
                ...
                .css({
                    "background-color":
                        Nodes.imgsToDraw[Nodes.currentShapeIndex]
                            .backgroundColor,
                });
        },
        ...
        shapeTextDisplay: function (index, index2, seek) {
            ...
            if (seek !== false) {
                jQuery(Nodes.canvasID)
                    .parents($selector)
                    .find(".inner-wrap:not(.shape-" + index + ")")
                    .each(function (i) {
                        $(this)
                            .find("> *")
                            .each(function (i) {
                                $(this)
                                    .stop(true, true)
                                    .delay(i * 150)
                                    .transition({ opacity: "0" }, 250, "ease");
                            });
                    });
                Nodes.resetShapeTextTimeout = setTimeout(
                    function () {
                        jQuery(Nodes.canvasID)
                            .parents($selector)
                            .find(".inner-wrap:not(.shape-" + index + ") > *")
                            .delay(50)
                            .transition({ rotateX: $rotate, y: "30px" }, 0);
                    },
                    jQuery(Nodes.canvasID)
                        .parents($selector)
                        .find(".inner-wrap:not(.shape-" + index + ")").length *
                        200
                );
            } else {
                jQuery(Nodes.canvasID)
        ...
        particleSequenceRotate: function () {
            setInterval(function () {
                ...
                for (var i = 0; i < Nodes.points.length; i++) {
                    //check for sequenced
                    if (
                        !jQuery.isArray(Nodes.points[i]) &&
                        typeof Nodes.points[i] === "object"
                    ) {
                        for (var j = 0; j < 1; j++) {
                            for (
                                var k = 0;
                                k < Nodes.points[i][0].length;
                                k++
                            ) {
                                ...
                                for (
                                    var u = 0;
                                    u <
                                    Nodes.points[i][Nodes.currentSequenceIndex]
                                        .length;
                                    u++
                                ) {
                                    otherPoint =
                                        Nodes.points[i][
                                            Nodes.currentSequenceIndex
                                        ][u];
                ...
                //update shape index
                Nodes.currentSequenceIndex =
                    Nodes.currentSequenceIndex + 1 ==
                    Object.keys(Nodes.points[Nodes.currentShapeIndex]).length
                        ? 0
                        : Nodes.currentSequenceIndex + 1;
            }, 80);
        },
            ...
            if (Nodes.loadedCount == Nodes.totalImgCount) {
                for (var i = 0; i < Nodes.imgsToDraw.length; i++) {
                    if (!jQuery.isArray(this.bgImage[i])) {
                        ...
                        for (
                            var j = 0;
                            j < Nodes.imgsToDraw[i].shape.length;
                            j++
                        ) {
        ...
        drawImageToBackground: function (index, index2, resize, sequence) {
            ...
            var $selector =
                $(".nectar-box-roll").length > 0
                    ...
                    : ".nectar-particles";
            var heightDiff =
                Nodes.textPosition == "bottom" &&
                Nodes.textPositionH == "center"
                    ? $(Nodes.canvasID)
                          .parents($selector)
                          .find(".inner-wrap")
                          .height() /
            ...
            //   console.log("IMAGE TOO BIG FOR SCREEN")
            ...
            // } else {
            // console.log("IMAGE GOOD FOR SCREEN")
            ...
            console.log("bgcanvas width: " + this.bgCanvas.width);
    ...
    function initTextEffect(canvasID) {
        ...
        var $timeOut =
            $(canvasID).parents('#page-header-bg[data-text-effect="rotate_in"]')
                .length > 0
                ? 800
                : 0;
        setTimeout(function () {
            $(canvasID)
                .parents($selector)
                .find(".inner-wrap.shape-1")
                .css("z-index", 100);
            $(canvasID)
                .parents($selector)
                .find(".inner-wrap.shape-1 .top-heading")
                .transition({ opacity: 1, y: 0 }, 0);
            ...
            setTimeout(function () {
                $(canvasID)
                    .parents($selector)
                    .find(".span_6")
                    .find(".inner-wrap.shape-1 > *:not(.top-heading)")
                    .each(function (i) {
                        $(this)
                            .delay(i * 370)
                            .transition(
                ...
                setTimeout(function () {
                    ...
                    if (Nodes.imgsToDraw.length > 1) {
                        $(".pagination-dots .pagination-dot").each(function (
                            i
                        ) {
                            $(this)
                                .delay(i * 75)
                                .transition({ y: 0, opacity: 1 }, 400);
                        });
                        $(".pagination-navigation .pagination-current").each(
                            function (i) {
                                $(this)
                                    .delay(i * 75)
                                    .transition(
                                        { y: 0, opacity: 1, scale: 1.15 },
                                        400
                                    );
                            }
                        );
                        ...
                        setTimeout(function () {
                            ...
                            .parents($selector)
                            .find(".pagination-dot").length *
                            75 +
                            370);
                    }
                }, $(canvasID)
                    .parents($selector)
                    .find(".inner-wrap.shape-1 > *:not(.top-heading)").length -
                    1 * 400 +
                    370);
            }, $(canvasID).parents($selector).find(".span_6").find(".wraped")
                .length * 370);
        }, $timeOut);
    }
    ...
    function boxRoll(e, d) {
        ...
        if (
            ...
            animating == "false" &&
            d == -1 &&
            $('.nectar-box-roll canvas[data-loaded="true"]').length > 0
        ) {
            perspect = "rolled";
            animating = "true";
            //stop mouse movement
    ...
    if ($shapes.length > 0 && $(".nectar-box-roll").length > 0) {
        ...
        $("body").on(
            "click",
            ".nectar-box-roll .section-down-arrow",
            function () {
                boxRoll(null, -1);
